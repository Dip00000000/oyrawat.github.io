...
<html lang="en">
     <head>
     <title>Oyrawat Properties|Commmercial Properties</title>
...
if(isset($_GET['key'])){
           ...
           $resultsperpage=10;
           $stmt=$con->prepare("SELECT * FROM project_commercial_details
...
$data=$stmt->fetchAll();
           ...
           $start=($page-1)*$resultsperpage;
            ...
            $stmt=$con->prepare("SELECT * FROM project_commercial_details ORDER BY project DESC LIMIT $start,$resultsperpage");
            $stmt->execute();
...
foreach($data as $row){
  ...
  $img=ltrim($commercial_project_pic,".");
  $project=$row['project'];
                                 ...
                                 echo  "<table class='table font font_size_4'>";
                                  ...
                                  echo '</table>'; 
                                    ...
                                    echo "<div class='text-end font_size_2'>";
                                           echo "<a href='commercial_property_details.php?project=$project&developer=$developer&location=$location' style='color:darkorange;text-decoration:none;'>View Details</a>";
                                           echo "&nbsp;";
