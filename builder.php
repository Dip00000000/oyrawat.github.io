...
$data=$stmt->fetchAll();
           ...
           $start=($page-1)*$resultsperpage;
            ...
            $stmt=$con->prepare("SELECT * FROM project_builder ORDER BY project DESC LIMIT $start,$resultsperpage");
            $stmt->execute();
                                  ...
                                  echo "<table class='table font_size_2'>";
                                        echo "<thead>"; 
                                         ...
                                         echo "</thead>";
                                              ...
                                              $stmt1=$con->prepare("SELECT * FROM project_builder_configuration WHERE project='$project' AND developer='$developer' LIMIT 3");
                                              $stmt1->execute();
                                    ...
                                    echo "<div class='text-end font_size_2'>";
                                           echo "<a href='builder_property_details.php?project=$project&developer=$developer' style='color:darkorange;text-decoration:none;'>View Details</a>";
                                           echo "&nbsp;";
...
<div class="row">
   ...
   <?php
                if($page<$totalpages){
                     echo "<a href='commercial.php?page=".($page+1)."'>Next&gt;&gt;</a>";
                     echo "&nbsp;";
                     echo "<a href='commercial.php?page=".$rowcount."'>Last&gt;&gt;</a>";  
                     }

                if($page>=2){   
                     echo "<a href='commercial.php?page=".($page-1)."'>  &lt;&lt;Prev </a>";
                     echo "&nbsp;";
                     echo "<a href='commercial.php?page=1'>&lt;&lt;First</a>"; 
                     echo "&nbsp;";   
                     }
    ...
    <div class="modal-content bg-primary">
      ...
      <h2 style="color:white;">Enquire for a Call Back</h2>
        ...
        <input type="text" class="form-control form-control-lg" placeholder="Enter Phone Number">
         <br>
         <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Send Enquiry"></textarea>
        </form>
      </div>

      <!-- Modal footer -->
      <div class="modal-footer" style="border:none;">
        <button type="button" class="btn btn-warning align-left" data-bs-dismiss="modal">Send Enquiry</button>
      </div>
