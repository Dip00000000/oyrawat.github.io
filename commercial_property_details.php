...
<div class="row">
    ...
    <div class="col-sm-8">
                 ...
                 <div class="col-sm-12">
                        <div class="swiffy-slider">  
                                <ul class="slider-container">
                                   ...
                                   $sql="SELECT * FROM project_commercial_banner WHERE project='$project' AND location='$location' AND developer='$developer'";
                                   $stmt=$con->prepare($sql);
                                   $stmt->execute();
                                   $data=$stmt->fetchAll();
                                   foreach($data as $row){
                                      $project_commercial_pic1=$row['project_commercial_pic1'];
                                      $pic='.'.ltrim($project_commercial_pic1,'.');
          ...
          <div class="row bg-body" id="property_intro">
             ...
             <?php
                    require './controller/dbcon.php';
                    $sql="SELECT * FROM project_commercial_intro WHERE project='$project' AND location='$location' AND developer='$developer'";
                    $stmt=$con->prepare($sql);
                    $stmt->execute();
                    $data=$stmt->fetchAll();
                    foreach($data as $row){
                      $project_commercial_intro=$row['project_commercial_intro'];
                      echo $project_commercial_intro;
                      }
          ...
          <div class="row bg-body" id="property_amenities">
                 <div class="col-sm-12">
                         ...
                         <?php
                                require './controller/dbcon.php';
                                $sql="SELECT * FROM project_commercial_amenities WHERE project='$project' AND location='$location' AND developer='$developer'";
                                $stmt=$con->prepare($sql);
                                $stmt->execute();
          ...
          <div class="row bg-body" id="property_configuration">
           ...
           <div class="row bg-body" id="property_specifications">  
             ...
             <div class="row">
               <div class="col-sm-12" style="padding:25px; column-count:2;">
                   <?php
                      require "./controller/dbcon.php";
                      $sql="SELECT * FROM project_commercial_specifications WHERE project='$project' AND developer='$developer' AND location='$location'";
                      $stmt=$con->prepare($sql);
                      $stmt->execute();
                      $data=$stmt->fetchAll();
                       foreach($data as $row){
           ...
           <div class="row bg-body" id="payment_plan">
               <div class="col-sm-12">
                  ...
                  <?php 
                  require './controller/dbcon.php';
                  $sql="SELECT * FROM project_commercial_payment WHERE project='$project' AND location='$location' AND developer='$developer'";
                  $stmt=$con->prepare($sql);
                  $stmt->execute();
                  $data=$stmt->fetchAll();                 
      ...
      <div class="col-sm-12">
             <div class="swiffy-slider slider-item-show4 slider-item-reveal slider-nav-outside slider-nav-round slider-nav-visible slider-indicators-outside slider-indicators-round slider-indicators-dark slider-nav-animation slider-nav-animation-fadein slider-item-first-visible">
                    <ul class="slider-container">
                         ...
                         $data=$stmt->fetchAll();
                         foreach($data as $row){
                          $commercial_project_pic=$row['commercial_project_pic'];
                          $pic='.'.ltrim( $commercial_project_pic,'.');
                          $project=$row['project'];
