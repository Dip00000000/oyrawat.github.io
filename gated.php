...
<html lang="en">
     <head>
     <title>Oyrawat Properties|Gated Properties</title>
...
.material-symbols-sharp {
  ...
  'opsz' 48
     ...
     </head><body><div class="container-fluid"><?php require 'header.php';?>
<div class="row">
...
$data=$stmt->fetchAll();
           ...
           $start=($page-1)*$resultsperpage;
            ...
            $stmt=$con->prepare("SELECT * FROM project_gated ORDER BY project DESC LIMIT $start,$resultsperpage");
            $stmt->execute();
                                  ...
                                  echo "<table class='table font_size_2'>";
                                        echo "<thead>"; 
                                         ...
                                         echo "</thead>";
                                              ...
                                              $stmt1=$con->prepare("SELECT * FROM project_gated_configuration WHERE project='$project' AND developer='$developer' LIMIT 3");
                                              $stmt1->execute();
                                    ...
                                    echo "<div class='text-end font_size_2'>";
                                           echo "<a href='gated_property_details.php?project=$project&developer=$developer' style='color:darkorange;text-decoration:none;'>View Details</a>";
                                           echo "&nbsp;";
...
<div class="row">
   ...
   <?php
                if($page<$totalpages){
                     echo "<a href='gated.php?page=".($page+1)."'>Next&gt;&gt;</a>";
                     echo "&nbsp;";
                     echo "<a href='gated.php?page=".$rowcount."'>Last&gt;&gt;</a>";  
                     }

                if($page>=2){   
                     echo "<a href='gated.php?page=".($page-1)."'>  &lt;&lt;Prev </a>";
                     echo "&nbsp;";
                     echo "<a href='gated.php?page=1'>&lt;&lt;First</a>"; 
                     echo "&nbsp;";   
                     }
